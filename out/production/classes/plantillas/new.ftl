...
<header class="header bg-primary">
    ...
    <a href="/inicio" class="logo"><b>Encuestas</b></a>
...
<div style="padding-top: 50px" class="container">
    <h1 class="well">Formulario de las Encuestas</h1>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="niveleducativo">Nivel Educativo:</label>
                                    <select name="niveleducativo" id="niveleducativo" class="form-control" required autofocus>
...
<script type="application/javascript">
    ...
    function insertarDB() {
        ...
        var niveleducativo_encuestado = document.getElementById("niveleducativo").value;
        ...
        request = encuestados.add({
            ...
            niveleducativo: niveleducativo_encuestado,
    ...
    function editarDB() {
        ...
        encuestados.get(document.getElementById("id").value).onsuccess = function(e) {
            ...
            if(resultado !== undefined){
                ...
                document.querySelector("#niveleducativo").value = resultado.niveleducativo;
            }else{
    ...
    function guardarCambios(){
        ...
        encuestados.get(document.getElementById("id").value).onsuccess = function(e) {
            ...
            if(resultado !== undefined){
                ...
                resultado.nivelEducativo = document.querySelector("#niveleducativo").value ;
