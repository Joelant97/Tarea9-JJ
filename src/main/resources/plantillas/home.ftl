...
<header class="header bg-primary">
    <a href="/inicio" class="logo"><b>Práctica 9</b></a>

</header>
<div style="padding-top: 50px" class="container">
    <h1 class="well">Listado de Encuestas</h1>
...
<script type="application/javascript">
    ...
    function listarDatos() {
        ...
        data.oncomplete = function () {
            ...
            //Mando todos los campos a sincronizar a travez de un JSON.
    function sincronizar(lista){
        console.log(lista);
        for (var key in lista) {
            console.log( lista[key].nombre+"/"+lista[key].sector+ "/"
                    + lista[key].niveleducativo+"/"+lista[key].latitud+"/"+ lista[key].longitud);
            ...
            $.ajax({
                ...
                data:JSON.stringify({
                    ...
                    nivelEducativo:lista[key].niveleducativo,
